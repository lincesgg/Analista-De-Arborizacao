...
# Paths
original_image_path = "Condominio_original.png"
delimitated_image_path = "Condominio_delimitado.png"
...
if should_apply_initial_mask:
    initial_mask, inital_mask_pixel_amout = return_initial_mask(original_image_path, delimitated_image_path, should_analyze_just_the_biggest_shape)
